...
public class IconDemoApplet extends JApplet implements ActionListener,ItemListener {
    ...
    private String imagedir = "/home/manjuprasad/javaworkspace/IconDemoApplet/images/";
    ...
    public void init() {
        ...
        setName("Icon Demo: Please Select an Image");
        ...
        try{
        	  DataRead("/home/manjuprasad/javaworkspace/IconDemoApplet/intro");
 ...
 public int k;
    ...
    private class ThumbnailAction extends AbstractAction {
         ...
         * @param Icon - The thumb nail to show in the button.
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (int i = 0; i < imageCaptions.length; i++){
            	if(getValue(SHORT_DESCRIPTION).equals(imageCaptions[i])){
            		try{
                   	  DataRead("/home/manjuprasad/javaworkspace/IconDemoApplet/"+imagedescription[i]);
                     }catch(IOException ex){
                   	  System.out.println(ex);
                     }
            	}
